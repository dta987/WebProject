		...
		<table class="table" align="center">
			...
			<tbody>
				<c:forEach var="bean" items="${requestScope.lists}">
					<tr>
						<td><a
							href="<%=MyCtrlCommand%>boDetailView&no=${bean.group_no}&${requestScope.parameters}">${bean.group_no}</a></td>
						<td>${bean.user_nickname}</a></td>
						<td>${bean.board_writ_date}</td>
						<td>${bean.board_update}</td>
						<td><a
							href="<%=MyCtrlCommand%>boUpdateForm&no=${bean.board_no}&${requestScope.parameters}"> 수정
						</a></td>
						<td><a id="del"
							href="<%=MyCtrlCommand%>boDelete&no=${bean.board_no}&${requestScope.parameters}"> 삭제 </a></td>
